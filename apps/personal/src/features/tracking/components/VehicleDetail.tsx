...
import { ArrowLeft, Car, MapPin, Clock, Play, Route, WifiOff, ChevronLeft, ChevronRight, CalendarDays, Share2, ChevronDown, ChevronUp } from 'lucide-react';
...
export function VehicleDetail({
  ...
  return (
    <div className="flex flex-col h-full bg-surface text-foreground border-r border-border">
      {/* Header */}
      <div 
        className="flex items-center justify-between px-4 py-4 shrink-0 border-b border-border bg-surface cursor-pointer md:cursor-default"
        onClick={(e) => {
      ...
      >
        ...
        {onToggleDetail && (
          <button
            ...
            className="p-1.5 text-foreground-muted hover:text-foreground transition-colors rounded-full hover:bg-surface-elevated flex items-center justify-center bg-surface-elevated/50 md:bg-transparent"
