...
export const cardDictionaries = {
  id: {
    ...
    form: {
      title: 'Edit Card',
      sectionHolder: 'Pemegang Card',
      descHolder: 'Pengikatan kartu ke Driver atau Personel.',
      labelHolderType: 'Tipe Pemegang',
      labelHolder: 'Pemegang',
      valDriver: 'Driver',
      valPersonel: 'Personel',
      valNone: 'Tidak Ada',
  ...
  en: {
    ...
    form: {
      title: 'Edit Card',
      sectionHolder: 'Card Holder',
      descHolder: 'Assignment to Driver or Personel.',
      labelHolderType: 'Holder Type',
      labelHolder: 'Holder',
      valDriver: 'Driver',
      valPersonel: 'Personel',
      valNone: 'None',
